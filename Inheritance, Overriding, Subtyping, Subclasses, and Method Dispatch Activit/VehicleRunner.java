...
public class VehicleRunner {
    public static void main(String[] args) {
        ...
        System.out.println("Toyota Vios speed: " + toyotaVios.getSpeed() + " km/h");
        ...
        U2SpyPlane u2SpyPlane = new U2SpyPlane(700.0, "Red", 10000000.0, 80.0, "U-2");
        System.out.println("U2 Spy Plane speed: " + u2SpyPlane.getSpeed() + " km/h");
        ...
        System.out.println("Fandango Yacht speed: " + fandangoYacht.getSpeed() + " mph");
